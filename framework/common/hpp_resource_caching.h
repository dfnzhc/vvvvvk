...
namespace std
{
    ...
    template <>
    struct hash<vkb::common::load_store_info>
    {
        size_t operator()(vkb::common::load_store_info const& lsi) const
        {
            size_t result = 0;
...
namespace vkb
{
    ...
    namespace
    {
        ...
        template <class... A>
        struct record_helper<vkb::core::shader_module, A...>
        {
            size_t record(resource_record& recorder, A&... args)
            {
        ...
        template <class... A>
        struct record_helper<vkb::core::pipeline_layout, A...>
        {
            size_t record(resource_record& recorder, A&... args)
            {
        ...
        template <class... A>
        struct record_helper<vkb::core::render_pass, A...>
        {
            size_t record(resource_record& recorder, A&... args)
            {
        ...
        template <class... A>
        struct record_helper<vkb::core::graphics_pipeline, A...>
        {
            size_t record(resource_record& recorder, A&... args)
            {
    ...
    {
        record_helper<T, A...> record_helper;
