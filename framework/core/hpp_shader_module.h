...
namespace vkb
{
    namespace core
    {
        ...
        class shader_source : private vkb::ShaderSource
        {
        public:
            shader_source(const std::string& filename) :
                vkb::ShaderSource(filename)
            {
            }
        };

        class shader_variant : private vkb::ShaderVariant
        {
        };

        class shader_module : private vkb::ShaderModule
        {
        public:
            using vkb::ShaderModule::get_id;

        public:
            shader_module(vkb::core::device& device,
