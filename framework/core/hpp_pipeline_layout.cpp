...
namespace core
{
HPPPipelineLayout::HPPPipelineLayout(vkb::core::device &device, const std::vector<vkb::core::shader_module *> &shader_modules) :
    device{device},
...
vkb::core::descriptor_set_layout const &HPPPipelineLayout::get_descriptor_set_layout(const uint32_t set_index) const
{
...
const std::vector<vkb::core::shader_module *> &HPPPipelineLayout::get_shader_modules() const
{
