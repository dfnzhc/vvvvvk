...
namespace core
{
HPPCommandBuffer::HPPCommandBuffer(vkb::core::command_pool &command_pool, vk::CommandBufferLevel level) :
...
void HPPCommandBuffer::bind_image(
    const vkb::core::image_view &image_view, const vkb::core::HPPSampler &sampler, uint32_t set, uint32_t binding, uint32_t array_element)
{
	resource_binding_state.bind_image(image_view, sampler, set, binding, array_element);
}

void HPPCommandBuffer::bind_image(const vkb::core::image_view &image_view, uint32_t set, uint32_t binding, uint32_t array_element)
{
...
void HPPCommandBuffer::bind_input(const vkb::core::image_view &image_view, uint32_t set, uint32_t binding, uint32_t array_element)
{
...
void HPPCommandBuffer::blit_image(const vkb::core::image &src_img, const vkb::core::image &dst_img, const std::vector<vk::ImageBlit> &regions)
{
...
void HPPCommandBuffer::copy_image(const vkb::core::image &src_img, const vkb::core::image &dst_img, const std::vector<vk::ImageCopy> &regions)
{
...
void HPPCommandBuffer::copy_image_to_buffer(const vkb::core::image              &image,
...
void HPPCommandBuffer::image_memory_barrier(const vkb::core::image_view &image_view, const vkb::common::HPPImageMemoryBarrier &memory_barrier) const
{
...
void HPPCommandBuffer::resolve_image(const vkb::core::image &src_img, const vkb::core::image &dst_img, const std::vector<vk::ImageResolve> &regions)
{
								...
								switch (binding_info->descriptorType)
								{
									...
									case vk::DescriptorType::eInputAttachment:
										image_info.imageLayout =
										    vkb::common::is_depth_format(image_view->format()) ? vk::ImageLayout::eDepthStencilReadOnlyOptimal : vk::ImageLayout::eShaderReadOnlyOptimal;
										break;
