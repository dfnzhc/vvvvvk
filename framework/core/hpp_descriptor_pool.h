...
namespace vkb
{
    namespace core
    {
         ...
         */
        class descriptor_pool : private vkb::DescriptorPool
        {
        public:
            descriptor_pool(vkb::core::device& device, const vkb::core::descriptor_set_layout& descriptor_set_layout, uint32_t pool_size = MAX_SETS_PER_POOL) :
