 ...
 */
class HPPCommandBuffer : public core::vk_unit<vk::CommandBuffer>
{
  public:
  ...
  public:
	HPPCommandBuffer(vkb::core::command_pool &command_pool, vk::CommandBufferLevel level);
  ...
  private:
	...
	vkb::core::command_pool       &command_pool;
	...
	std::unordered_map<uint32_t, vkb::core::descriptor_set_layout const *> descriptor_set_layout_binding_state;
};
