...
HPPRenderContext::HPPRenderContext(vkb::core::device                    &device,
...
void HPPRenderContext::prepare(size_t thread_count, vkb::rendering::render_target::CreateFunc create_render_target_func)
{
	...
	else
	{
		...
		auto color_image = vkb::core::image{device,
...
vkb::core::device &HPPRenderContext::get_device()
{
	return device;
}
