...
class HPPImage : public vkb::sg::Component
{
  ...
  public:
	...
	void                                                        create_vk_image(vkb::core::device &device, vk::ImageViewType image_view_type = vk::ImageViewType::e2D, vk::ImageCreateFlags flags = {});
	...
	const vkb::core::image                                  &get_vk_image() const;
	const vkb::core::image_view                              &get_vk_image_view() const;
  ...
  private:
	...
	std::unique_ptr<vkb::core::image>                 vk_image;
	std::unique_ptr<vkb::core::image_view>             vk_image_view;
};
