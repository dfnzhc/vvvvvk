...
namespace vkb
{
    ...
    bool HPPVulkanSample::prepare(const vkb::ApplicationOptions& options)
    {
...
#ifdef VKB_VULKAN_DEBUG
        {
            ...
            if (debugExtensionIt != available_instance_extensions.end())
            {
                ...
                debug_utils = std::make_unique<vkb::core::debug_utils_ext_debug_utils>();
        ...
        if (!debug_utils)
        {
            ...
            if (debugExtensionIt != available_device_extensions.end())
            {
                ...
                debug_utils = std::make_unique<vkb::core::debug_marker_ext_debug_utils>();
        ...
        if (!debug_utils)
        {
            debug_utils = std::make_unique<vkb::core::dummy_debug_utils>();
        }

        device = std::make_unique<vkb::core::device>(gpu, surface, std::move(debug_utils), get_device_extensions());
    ...
    vkb::core::instance const& HPPVulkanSample::get_instance() const
    {
        return *instance;
    }

    std::unique_ptr<vkb::core::device> const& HPPVulkanSample::get_device() const
    {
        return device;
    }
    ...
    void HPPVulkanSample::request_gpu_features(vkb::core::physical_device& gpu)
    {
