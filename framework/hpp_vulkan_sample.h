...
class HPPVulkanSample : public vkb::Application
{
  public:
	...
	vkb::core::instance const &get_instance() const;

	std::unique_ptr<vkb::core::device> const &get_device() const;
  ...
  protected:
	 ...
	 */
	std::unique_ptr<vkb::core::instance> instance;

	/**
	 * @brief The Vulkan device
	 */
	std::unique_ptr<vkb::core::device> device;
	 ...
	 */
	virtual void request_gpu_features(vkb::core::physical_device &gpu);
